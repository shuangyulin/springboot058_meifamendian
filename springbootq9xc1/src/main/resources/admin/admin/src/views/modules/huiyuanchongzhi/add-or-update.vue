<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="充值方式" prop="chongzhifangshi">
          <el-select v-model="ruleForm.chongzhifangshi" placeholder="请选择充值方式">
            <el-option
                v-for="(item,index) in chongzhifangshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="充值方式" prop="chongzhifangshi">
	      <el-input v-model="ruleForm.chongzhifangshi"
                placeholder="充值方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jine = true;
          ...
          if(o=='chongzhifangshi'){
            this.ruleForm.chongzhifangshi = obj[o];
	    this.ro.chongzhifangshi = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
		...
		if(json.zhanghao!=''&&json.zhanghao){
          ...
          this.$message.error(data.msg);
            ...
            this.chongzhifangshiOptions = "办卡,续费".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
