<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="产品数量" prop="chanpinshuliang">
          <el-input v-model="ruleForm.chanpinshuliang" 
              placeholder="产品数量" clearable  :readonly="ro.chanpinshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="产品数量" prop="chanpinshuliang">
              <el-input v-model="ruleForm.chanpinshuliang" 
                placeholder="产品数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="产品售价" prop="chanpinshoujia">
          <el-input v-model="ruleForm.chanpinshoujia" 
              placeholder="产品售价" clearable  :readonly="ro.chanpinshoujia"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="产品售价" prop="chanpinshoujia">
              <el-input v-model="ruleForm.chanpinshoujia" 
                placeholder="产品售价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	chanpinshuliang : false,
	chanpinshoujia : false,
	zongjia : false,
	beizhu : false,
	shouhuodizhi : false,
	lianxidianhua : false,
  ...
  computed: {
    zongjia:{
      get: function () {
        return 1*this.ruleForm.chanpinshuliang*this.ruleForm.chanpinshoujia
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chanpinleixing = true;
          ...
          if(o=='chanpinshuliang'){
            this.ruleForm.chanpinshuliang = obj[o];
	    this.ro.chanpinshuliang = true;
            continue;
          }
          if(o=='chanpinshoujia'){
            this.ruleForm.chanpinshoujia = obj[o];
	    this.ro.chanpinshoujia = true;
            continue;
          }
          if(o=='zongjia'){
        ...
        this.ruleForm.chanpinshuliang = 0
	this.ro.chanpinshuliang = false;
      }
      // 获取用户信息
      this.$http({
    ...
    onSubmit() {
      ...
      if(obj!=null) {
	      obj.chanpinshuliang = obj.chanpinshuliang - this.ruleForm.chanpinshuliang
	      if(obj.chanpinshuliang<0){
		this.$message.error("产品数量不足");
		return
	      }
	      this.$http({
		  url: `${table}/update`,
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `chanpingoumai/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chanpingoumaiCrossAddOrUpdateFlag = false;
                  this.parent.search();
