<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会员卡名称" prop="huiyuankamingcheng">
          <el-input v-model="ruleForm.huiyuankamingcheng" 
              placeholder="会员卡名称" clearable  :readonly="ro.huiyuankamingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会员卡名称" prop="huiyuankamingcheng">
              <el-input v-model="ruleForm.huiyuankamingcheng" 
                placeholder="会员卡名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会员卡类型" prop="huiyuankaleixing">
          <el-input v-model="ruleForm.huiyuankaleixing" 
              placeholder="会员卡类型" clearable  :readonly="ro.huiyuankaleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会员卡类型" prop="huiyuankaleixing">
              <el-input v-model="ruleForm.huiyuankaleixing" 
                placeholder="会员卡类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会员卡期限" prop="huiyuankaqixian">
          <el-input v-model="ruleForm.huiyuankaqixian" 
              placeholder="会员卡期限" clearable  :readonly="ro.huiyuankaqixian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会员卡期限" prop="huiyuankaqixian">
              <el-input v-model="ruleForm.huiyuankaqixian" 
                placeholder="会员卡期限" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="会员卡介绍" prop="huiyuankajieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="会员卡介绍"
                  v-model="ruleForm.huiyuankajieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huiyuankajieshao" label="会员卡介绍" prop="huiyuankajieshao">
                    <span>{{ruleForm.huiyuankajieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	huiyuankajieshao : false,
	huiyuankaqixian : false,
	jine : false,
	faburiqi : false,
	tupian : false,
      },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huiyuankaleixing = true;
          ...
          if(o=='huiyuankajieshao'){
            this.ruleForm.huiyuankajieshao = obj[o];
	    this.ro.huiyuankajieshao = true;
            continue;
          }
          if(o=='huiyuankaqixian'){
            this.ruleForm.huiyuankaqixian = obj[o];
	    this.ro.huiyuankaqixian = true;
            continue;
          }
          if(o=='jine'){
